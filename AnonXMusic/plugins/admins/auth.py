...
@app.on_message(filters.command(["auth","رفع ادمن","ر ادمن"], "") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(filters.command(["unauth","ت ادمن","تنزيل ادمن"], "") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(
    filters.command(["authlist", "authusers","الادمنيه","قائمة الادمن"], "") & filters.group & ~BANNED_USERS
)
@language
