...
@app.on_message(
    filters.command(["end", "stop", "cend", "cstop","ايقاف","#ايقاف","انهاء","#انهاء"],"") & filters.group & ~BANNED_USERS
)
@AdminRightsCheck
...
@app.on_message(
    filters.command(["end", "stop", "cend", "cstop","ايقاف","#ايقاف","انهاء","#انهاء"],"") & filters.channel & ~BANNED_USERS
)
@AdminRightsCheck
