...
@app.on_message(
    filters.command(["admincache", "reload", "refresh","ريلود","ريستارت"],"") & filters.group & ~BANNED_USERS
)
@language
...
@app.on_message(filters.command(["reboot","ريبوت"], "") & filters.group & ~BANNED_USERS)
@AdminActual
