...
@app.on_message(filters.command(["block","حظر"], "") & SUDOERS)
@language
...
@app.on_message(filters.command(["unblock","الغاء حظر"], "") & SUDOERS)
@language
...
@app.on_message(filters.command(["blocked", "blockedusers", "blusers","المحظورين","قائمة الحظر"], "") & SUDOERS)
@language
