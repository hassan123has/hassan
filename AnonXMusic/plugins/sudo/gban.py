...
@app.on_message(filters.command(["gban", "globalban","عام"],"") & SUDOERS)
@language
...
@app.on_message(filters.command(["ungban","الغاء العام"], "") & SUDOERS)
@language
...
@app.on_message(filters.command(["gbannedusers", "gbanlist","قائمة العام"],"") & SUDOERS)
@language
