...
@app.on_message(filters.command(["getlog", "logs", "getlogs","السجل"],"") & SUDOERS)
@language
...
@app.on_message(filters.command(["update", "gitpull","تحديث"],"") & SUDOERS)
@language
...
@app.on_message(filters.command(["restart","اعادة تشغيل"], "") & SUDOERS)
