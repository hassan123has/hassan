...
@app.on_message(filters.command(["blchat", "blacklistchat","بلاك ليست"],"") & SUDOERS)
@language
...
@app.on_message(
    filters.command(["whitelistchat", "unblacklistchat", "unblchat","ونبلاك"],"") & SUDOERS
)
@language
...
@app.on_message(filters.command(["blchats", "blacklistedchats","البلاك ليست","القائمه السوداء"],"") & ~BANNED_USERS)
@language
